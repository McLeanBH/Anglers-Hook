...
define('final/adapters/weather-radar', ['exports', 'ember'], function (exports, Ember) {
...
define('final/models/user', ['exports', 'ic-ajax', 'ember-magic-man/model'], function (exports, ajax, Model) {
  ...
  exports['default'] = Model['default'].extend({
    addFavorite: function addFavorite(user) {
...
define('final/routes/segue/leaders', ['exports', 'ember'], function (exports, Ember) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el5,"src","assets/img/home.png");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        dom.appendChild(el3, el4);
        ...
        dom.setAttribute(el4,"href","/segue/leaders");
        var el5 = dom.createTextNode("\n      ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("img");
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","assets/img/compass-logo.png");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","assets/img/nav-48.png");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        dom.appendChild(el3, el4);
        ...
        dom.setAttribute(el4,"href","/segue/dashboard");
        var el5 = dom.createTextNode("\n      ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("img");
        ...
        dom.setAttribute(el4,"href","http://twitter.com/intent/tweet?screen_name=theanglershook");
        var el5 = dom.createTextNode("\n      ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("img");
        ...
        var el3 = dom.createTextNode("\n\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment(" <li class=\"footer-icons\"><a title=\"Facebook\" target=\"_blank\" href=\"https://www.facebook.com/marlinmag\">\n      <img src=\"assets/img/fb.png\"></a>\n    </li> ");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("li");
        ...
        dom.setAttribute(el4,"href","/segue/show");
        var el5 = dom.createTextNode("\n      ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("img");
        dom.setAttribute(el5,"src","assets/img/search-logo.png");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n    ");
        dom.appendChild(el3, el4);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph0, context, "input", [], {"class": "reg-field r1 first-name inputters", "value": get(env, context, "model.firstName"), "placeholder": "First Name"});
        inline(env, morph1, context, "input", [], {"class": "reg-field r2 last-name inputters", "value": get(env, context, "model.lastName"), "placeholder": "Last Name"});
        inline(env, morph2, context, "input", [], {"class": "reg-field r1 email inputters", "value": get(env, context, "model.email"), "placeholder": "Email Address"});
        inline(env, morph3, context, "input", [], {"class": "reg-field r2 username inputters", "value": get(env, context, "model.username"), "placeholder": "Username"});
        inline(env, morph4, context, "input", [], {"type": "password", "class": "reg-field r1 password inputters", "value": get(env, context, "model.password"), "placeholder": "Password"});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        var el0 = dom.createDocumentFragment();
        var el1 = dom.createElement("div");
        dom.setAttribute(el1,"class","media-room");
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","forum-wrapper");
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","top-border-div");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n      ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("h1");
        dom.setAttribute(el3,"class","media-room-header");
        dom.setAttribute(el3,"contenteditable","");
        var el4 = dom.createTextNode("Media Room");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n\n      ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","photo-uploader");
        var el4 = dom.createTextNode("\n");
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("        ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("button");
        var el5 = dom.createTextNode("Upload Photo");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","photo-gallery");
        var el4 = dom.createTextNode("\n");
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("      ");
        dom.appendChild(el3, el4);
...
define('final/templates/segue/leaders', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          var el2 = dom.createTextNode("Mega Dock");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n      ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1,"class","megadock");
          var el2 = dom.createTextNode("\n        ");
          dom.appendChild(el1, el2);
          ...
          var el5 = dom.createTextNode("Boat");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          ...
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("th");
          var el5 = dom.createTextNode("Captain");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n          ");
          dom.appendChild(el3, el4);
          ...
          var el5 = dom.createTextNode("HalfLit");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("856 lb. Blue Marlin");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("120");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("R. Parker");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("R. Smith");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n          ");
          dom.appendChild(el3, el4);
          ...
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("Overspray");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("704 lb. White Marlin");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("110");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("J. Nicholson");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("J. Doe");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n          ");
          dom.appendChild(el3, el4);
          ...
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("Kraken");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("690 lb. Blue Marlin");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("105");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("J. Alda");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n            ");
          dom.appendChild(el3, el4);
          var el4 = dom.createElement("td");
          var el5 = dom.createTextNode("D. Koontz");
          dom.appendChild(el4, el5);
          dom.appendChild(el3, el4);
          var el4 = dom.createTextNode("\n          ");
          dom.appendChild(el3, el4);
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h3");
          var el2 = dom.createTextNode("Carolina Billfish Classic");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n      ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1,"class","carolina");
          var el2 = dom.createTextNode("\n        ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("table");
          var el3 = dom.createTextNode("\n          ");
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h3");
          var el2 = dom.createTextNode("Georgetown Blue Marlin Tournament");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n      ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1,"class","georgetown");
          var el2 = dom.createTextNode("\n        ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("table");
          var el3 = dom.createTextNode("\n          ");
          ...
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("h3");
          var el2 = dom.createTextNode("Bohicket Billfish Invitational");
          dom.appendChild(el1, el2);
          dom.appendChild(el0, el1);
          var el1 = dom.createTextNode("\n      ");
          dom.appendChild(el0, el1);
          var el1 = dom.createElement("div");
          dom.setAttribute(el1,"class","bohicket");
          var el2 = dom.createTextNode("\n        ");
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("table");
          var el3 = dom.createTextNode("\n          ");
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","leader-container");
        var el3 = dom.createTextNode("\n\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","gc-tourneys");
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("ul");
        dom.setAttribute(el4,"class","banner-list");
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","banner bibt");
        var el6 = dom.createElement("a");
        dom.setAttribute(el6,"href","http://bohicket.com/events/billfish-invitational/");
        var el7 = dom.createElement("img");
        dom.setAttribute(el7,"src","assets/img/events/bohicket.png");
        dom.setAttribute(el7,"alt","Bohicket Marina Invitational Billfish Tournament");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","banner gcbc");
        var el6 = dom.createElement("a");
        dom.setAttribute(el6,"href","http://www.fishcbc.com/");
        var el7 = dom.createElement("img");
        dom.setAttribute(el7,"src","assets/img/events/cdc2.png");
        dom.setAttribute(el7,"alt","Carolina Billfish Classic");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n      ");
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","banner gbft");
        var el6 = dom.createElement("a");
        dom.setAttribute(el6,"href","http://georgetownlandingmarina.com/");
        var el7 = dom.createElement("img");
        dom.setAttribute(el7,"src","assets/img/events/georgetown.png");
        dom.setAttribute(el7,"alt","Georgetown Blue Marlin Tournament");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","banner mega");
        var el6 = dom.createElement("a");
        dom.setAttribute(el6,"href","http://megadocktournament.com/");
        var el7 = dom.createElement("img");
        dom.setAttribute(el7,"src","assets/img/events/megadock.png");
        dom.setAttribute(el7,"alt","The Megadock Billfishing Tournament");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n      ");
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","leader-board");
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("h1");
        var el5 = dom.createTextNode("Leader Board");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("ul");
        dom.setAttribute(el3,"class","gc-logo");
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("li");
        var el5 = dom.createTextNode("\n      ");
        ...
        dom.setAttribute(el5,"href","http://govcup.dnr.sc.gov/");
        var el6 = dom.createElement("img");
        dom.setAttribute(el6,"src","assets/img/events/gc.png");
        dom.setAttribute(el6,"alt","The Governor's Cup");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n    ");
        dom.appendChild(el4, el5);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(dom.childAt(fragment, [0, 1, 3]),2,3);
        var morph1 = dom.createMorphAt(fragment,1,2,contextualElement);
        block(env, morph0, context, "jqui-accordion", [], {}, child0, null);
...
define('final/templates/segue/show', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("ul");
        dom.setAttribute(el3,"class","cb-slideshow");
        var el4 = dom.createTextNode("\n      	");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 01");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 02");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 03");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 04");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 05");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 06");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 07");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 08");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 09");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 10");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 11");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 12");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 13");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 14");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("span");
        var el6 = dom.createTextNode("Image 15");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n      ");
    ...
    var child0 = (function() {
      return {
        ...
        build: function build(dom) {
          ...
          dom.setAttribute(el4,"src","assets/img/mrmarlin.jpg");
          dom.appendChild(el3, el4);
          dom.appendChild(el2, el3);
          var el3 = dom.createTextNode("\n                     ");
          dom.appendChild(el2, el3);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph34 = dom.createMorphAt(dom.childAt(element5, [5]),2,3);
        var morph35 = dom.createMorphAt(fragment,1,2,contextualElement);
        ...
        inline(env, morph34, context, "input", [], {"class": "search-field", "type": "search", "placeholder": "Enter location...", "value": get(env, context, "searchTerm")});
        content(env, morph35, context, "outlet");
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment(" <form class=\"welcome-buttons\">\n      {{input class=\"welcomer wlogin\" value=login placeholder='Login'}}\n      {{input class=\"welcomer wregister\" value=reguster placeholder='Create An Account'}}\n    </form> ");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n  ");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
...
define('final/tests/adapters/photo.jshint', function () {

  'use strict';

  module('JSHint - adapters');
  test('adapters/photo.js should pass jshint', function() { 
    ok(true, 'adapters/photo.js should pass jshint.'); 
  });
...
define('final/tests/adapters/weather-radar.jshint', function () {
  ...
  test('adapters/weather-radar.js should pass jshint', function() { 
    ok(true, 'adapters/weather-radar.js should pass jshint.'); 
  });
...
define('final/tests/controllers/segue/forum.jshint', function () {
...
define('final/tests/models/photo.jshint', function () {
...
define('final/tests/routes/segue/leaders.jshint', function () {

  'use strict';

  module('JSHint - routes/segue');
  test('routes/segue/leaders.js should pass jshint', function() { 
    ok(true, 'routes/segue/leaders.js should pass jshint.'); 
  });
...
define('final/tests/unit/adapters/photo-test.jshint', function () {

  'use strict';

  module('JSHint - unit/adapters');
  test('unit/adapters/photo-test.js should pass jshint', function() { 
    ok(true, 'unit/adapters/photo-test.js should pass jshint.'); 
  });
...
define('final/tests/unit/controllers/segue/forum-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor("controller:segue/forum", {});
...
define('final/tests/unit/controllers/segue/forum-test.jshint', function () {

  'use strict';

  module('JSHint - unit/controllers/segue');
  test('unit/controllers/segue/forum-test.js should pass jshint', function() { 
    ok(true, 'unit/controllers/segue/forum-test.js should pass jshint.'); 
  });
...
define('final/tests/unit/models/photo-test.jshint', function () {
...
define('final/tests/unit/routes/leaders-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor("route:leaders", {});
...
define('final/tests/unit/routes/leaders-test.jshint', function () {

  'use strict';

  module('JSHint - unit/routes');
  test('unit/routes/leaders-test.js should pass jshint', function() { 
    ok(true, 'unit/routes/leaders-test.js should pass jshint.'); 
  });
