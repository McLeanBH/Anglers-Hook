...
define('final/components/google-map', ['exports', 'ember'], function (exports, Ember) {
    ...
    exports['default'] = Ember['default'].Component.extend({
        insertMap: (function () {
            ...
            var options = {
                center: new window.google.maps.LatLng(this.get("latitude"), this.get("longitude"), this.get("cloudLayer")),
                zoom: 15
            };
...
define('final/routes/segue/weather-radar', ['exports', 'ember'], function (exports, Ember) {
	...
	//   model: function(){
	//     return this.store.findQuery('radar');
	//   },
	//
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph6 = dom.createMorphAt(dom.childAt(element3, [3]),0,-1);
        var morph7 = dom.createMorphAt(element3,4,5);
        var morph8 = dom.createMorphAt(element3,5,6);
        var morph9 = dom.createMorphAt(dom.childAt(element3, [9]),-1,-1);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("div");
        dom.setAttribute(el2,"class","background-image");
        var el3 = dom.createTextNode("\n    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","species-wrapper");
        var el4 = dom.createTextNode("\n      ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("ul");
        dom.setAttribute(el4,"class","logo-list");
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        ...
        dom.setAttribute(el6,"class","ids");
        var el7 = dom.createTextNode("\n            ");
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("img");
        dom.setAttribute(el7,"src","/assets/img/marlin_logo.png");
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n          ");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        ...
        var el6 = dom.createElement("a");
        dom.setAttribute(el6,"class","ids");
        var el7 = dom.createTextNode("-- Billfish Identifier -->\n          ");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        var el6 = dom.createTextNode("\n\n          ");
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el6, el7);
        var el7 = dom.createElement("img");
        dom.setAttribute(el7,"src","/assets/img/sailfish_logo.png");
        dom.appendChild(el6, el7);
        var el7 = dom.createTextNode("\n          ");
        dom.appendChild(el6, el7);
        dom.appendChild(el5, el6);
        ...
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","chart chart-1");
        var el6 = dom.createElement("img");
        dom.setAttribute(el6,"src","/assets/img/species-1.png");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","chart chart-2");
        var el6 = dom.createElement("img");
        dom.setAttribute(el6,"src","/assets/img/chart-3.jpg");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n        ");
        dom.appendChild(el4, el5);
        var el5 = dom.createElement("li");
        dom.setAttribute(el5,"class","chart chart-3");
        var el6 = dom.createElement("img");
        dom.setAttribute(el6,"src","/assets/img/species-2.jpg");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode("\n      ");
        dom.appendChild(el4, el5);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph5 = dom.createMorphAt(dom.childAt(element0, [11]),-1,-1);
        var morph6 = dom.createMorphAt(fragment,1,2,contextualElement);
        var morph7 = dom.createMorphAt(element2,4,5);
        var morph8 = dom.createMorphAt(element2,5,6);
        var morph9 = dom.createMorphAt(element3,2,3);
        var morph10 = dom.createMorphAt(element3,3,4);
        var morph11 = dom.createMorphAt(element3,4,5);
        inline(env, morph0, context, "link-to", ["Register", "register"], {});
        inline(env, morph1, context, "link-to", ["Login", "login"], {});
        inline(env, morph2, context, "link-to", ["Map (temp)", "segue.view-one"], {});
        inline(env, morph3, context, "link-to", ["Species (temp)", "segue.species-ref"], {});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph7 = dom.createMorphAt(element1,0,1);
        var morph8 = dom.createMorphAt(element1,1,2);
        var morph9 = dom.createMorphAt(fragment,3,4,contextualElement);
        ...
        inline(env, morph7, context, "input", [], {"class": "welcomer wlogin", "value": get(env, context, "login"), "placeholder": "Login"});
        inline(env, morph8, context, "input", [], {"class": "welcomer wregister", "value": get(env, context, "reguster"), "placeholder": "Create An Account"});
...
define('final/tests/adapters/radar.jshint', function () {
...
if (runningTests) {
  ...
  require("final/app")["default"].create({"name":"final","version":"0.0.0.fea182fb"});
}
